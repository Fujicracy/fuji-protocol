...
describe("Core Fuji Instance", function () {
  ...
  describe("Aave as Provider", function () {
    ...
    describe("Native token as collateral, ERC20 as borrow asset.", function () {
      ...
      testRefinance1([vaultethdai, vaultethusdc, vaultethusdt], "aave", "compound", DEPOSIT_ETH, BORROW_STABLE, FLASHLOAN.AAVE);
      testRefinance1([vaultethdai, vaultethusdc], "aave", "compound", DEPOSIT_ETH, BORROW_STABLE, FLASHLOAN.DYDX);
      testRefinance1([vaultethdai, vaultethusdc, vaultethusdt], "aave", "compound", DEPOSIT_ETH, BORROW_STABLE, FLASHLOAN.CREAM);
    ...
    describe("ERC20 token as collateral, native token as borrow asset.", function () {
      ...
      testRefinance3([vaultdaieth, vaultusdceth], "aave", "compound", DEPOSIT_STABLE, BORROW_ETH, FLASHLOAN.AAVE);
      testRefinance3([vaultdaieth, vaultusdceth], "aave", "compound", DEPOSIT_STABLE, BORROW_ETH, FLASHLOAN.DYDX);
      testRefinance3([vaultdaieth, vaultusdceth], "aave", "compound", DEPOSIT_STABLE, BORROW_ETH, FLASHLOAN.CREAM);

      testRefinance3([vaultdaieth, vaultusdceth], "aave", "dydx", DEPOSIT_STABLE, BORROW_ETH, FLASHLOAN.AAVE);
      //testRefinance3([vaultdaieth, vaultusdceth], "aave", "dydx", DEPOSIT_STABLE, BORROW_ETH, FLASHLOAN.DYDX);
      testRefinance3([vaultdaieth, vaultusdceth], "aave", "dydx", DEPOSIT_STABLE, BORROW_ETH, FLASHLOAN.CREAM);

      testRefinance3([vaultdaieth, vaultusdceth], "aave", "ironBank", DEPOSIT_STABLE, BORROW_ETH, FLASHLOAN.AAVE);
      testRefinance3([vaultdaieth, vaultusdceth], "aave", "ironBank", DEPOSIT_STABLE, BORROW_ETH, FLASHLOAN.DYDX);
      // re-entered
